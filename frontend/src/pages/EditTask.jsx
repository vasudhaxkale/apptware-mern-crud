...
function EditTask() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSubmitError(err.response?.data?.error || err.message || 'Failed to update task');
    } finally {
      setSubmitting(false);
    }
  };
    ...
    return (
      <Layout>
        <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-center py-24" role="status" aria-label="Loading">
